...
{
    /// <inheritdoc />
    public partial class NotInital_FixFromPreviousMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RequiredDepartmentId = table.Column<Guid>(type: "uuid", nullable: false),
                    StudentDepartmentId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClearanceRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClearanceRules_Departments_RequiredDepartmentId",
                        column: x => x.RequiredDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClearanceRules_Departments_StudentDepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClearanceSignatories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClearanceSignatories_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClearanceSignatories_Faculties_FacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClearanceRules_RequiredDepartmentId_StudentDepartmentId",
                table: "ClearanceRules",
                columns: new[] { "RequiredDepartmentId", "StudentDepartmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClearanceRules_StudentDepartmentId",
                table: "ClearanceRules",
                column: "StudentDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ClearanceSignatories_DepartmentId",
                table: "ClearanceSignatories",
                column: "DepartmentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClearanceSignatories_FacultyId",
                table: "ClearanceSignatories",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_ClearanceSignatures_ClearanceFormId_DepartmentId",
                table: "ClearanceSignatures",
                columns: new[] { "ClearanceFormId", "DepartmentId" },
                unique: true);
